...
import dungeon.Angel;
import userjob.Hero;

import java.util.Random;

public class WisdomAngel extends Angel {// 지혜의 천사
    ...
    int useBasicAttack(Hero hero) {
        ...
        System.out.println("지혜의 대천사가 공격을 합니다. " + getBasicAttackName() + "!");
    ...
    int angelAttSkill(Hero hero) {
        ...
        System.out.println("지혜의 대천사가 스킬공격을 합니다. 영혼 수확!");
